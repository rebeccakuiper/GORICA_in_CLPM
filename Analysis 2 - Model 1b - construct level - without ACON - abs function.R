...
#
#[1] "'Phi' does not have a CTM-equivalent drift matrix. That is, there is no positive autocorrelation (as in the first-order continuous-time models), since one or more eigenvalues (have real parts which) are negative."
#Warning message:
#  In log(Eigen_ParamVAR) : NaNs produced
...
#2: In logm.Higham08(x) : NA/NaN from  || Tr - I ||  after 1 step.
...
# Explanation why it does not work here (and thus both render errors/warnings):
#> eigen(Phi)
#eigen() decomposition
#$values
